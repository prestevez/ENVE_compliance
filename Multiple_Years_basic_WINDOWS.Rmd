...
```{r 2014-import-data}
enve_2012 <- odbcConnectDbase("enve2012cuest_ciega_2012.dbf")
summary(enve_2012)

enve_delitos_2012 <- odbcConnectDbase("enve2012delitos_ciega_2012.dbf")
summary(enve_delitos_2012)

enve_2014 <- odbcConnectDbase("enve2014cuest_ciega_2014.dbf")
summary(enve_2014)

enve_delitos_2014 <- odbcConnectDbase("enve2014delitos_ciega_2014.dbf")
summary(enve_delitos_2014)

enve_2016 <- odbcConnectDbase("enve2016cuest_ciega_2016.dbf")
summary(enve_2016)

enve_delitos_2016 <- odbcConnectDbase("enve2016delitos_ciega_2016.dbf")
